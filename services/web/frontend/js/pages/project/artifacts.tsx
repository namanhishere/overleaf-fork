...
function ProjectArtifacts({ projectId }: { projectId: string }) {
  ...
  async function upload(files: FileList | null) {
    ...
    try {
      for (const file of files) {
        ...
        const res = await fetch(`/project/${projectId}/api/artifacts/upload`, {
          method: "POST",
          body: form,
        });
  ...
  return (
    <div className="container">
      ...
      <p>
        Non-source files of the project — data, figures, code and other research
        outputs — grouped by category. Uploads land in the{" "}
