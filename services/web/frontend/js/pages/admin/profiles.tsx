...
function ProfilesDashboard() {
  ...
  return (
    <div>
      ...
      <p>
        A profile pins a compile environment (image, compiler, TeX Live version,
        timeout). Applying a profile to a project sets its compiler and image;
        every compile job and release then records what was used.
      </p>
