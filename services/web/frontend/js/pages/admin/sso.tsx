...
function SsoDashboard() {
  ...
  async function refresh() {
    try {
      const data = await getJSON<{ providers: SsoProvider[] }>(
        "/admin/api/sso",
      );
  ...
  return (
    <div>
      ...
      <p>
        ...
        <a href="/admin/storage">Storage</a> · <a href="/admin/audit">Audit</a>
      </p>
      <p>
        OIDC identity providers are matched to local accounts by verified email.
        Enabled providers appear as login buttons on the login page. The client
        secret is write-only and never shown again.
      </p>
